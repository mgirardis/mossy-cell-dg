...
if rescaleCurr:
    ...
    coeff_exp = (0.0,1.0)
if saveExpData:
    expFileName = 'D:\\Dropbox\\p\\uottawa\\data\\mossy_cell_experiment\\by_current\\hMC_theta_I_curve'
...
mc_lat_data = scipy.io.loadmat('D:\\Dropbox\\p\\uottawa\\data\\mossy_cell_experiment\\by_current\\hMC_StepCurrent_1stLatency.mat')
